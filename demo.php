...
<script>
    ...
    "handler": function (response){
    	$.ajax({
    		type:"POST",
    		url:"demoserver.php",
    		data:"payid="+response.razorpay_payment_id+"&amount="+amount+"&availablebed="+Available_bed+"&bprice="+bprice+"&address="+add+"&pin="+pin+"&mno="+mno+"&img="+formData,
